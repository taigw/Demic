...
class DenseUNet2D(TrainableLayer):
    """
    ...
    def __init__(self,
                 ...
                 acti_func='prelu',
                 name='DenseUNet2D'):
        super(DenseUNet2D, self).__init__(name=name)
        
        if(parameters is None):
            self.n_features = [64, 64, 128, 128, 256]
            self.dropout    = 0.8
        else:
            self.n_features = parameters.get('num_features', [64, 64, 128, 128, 256])
